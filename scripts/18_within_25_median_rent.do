...
* Keep Listings with rents withing 25% of median rent
bys Zip_Code: egen median_rent=median(rent)

gen dev_rent=abs((rent-median_rent)/median_rent)

keep if dev_rent<=0.25
...
save "stores/aux/interquartile_toxconc_minority_within_med_rent.dta", replace
restore
...
save "stores/aux/interquartile_toxconc_AA_within_med_rent.dta", replace
restore
...
save "stores/aux/interquartile_toxconc_Hisp_within_med_rent.dta", replace
restore
